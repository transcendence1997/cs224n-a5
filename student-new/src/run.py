...
if args.function == 'pretrain':
    ...
    trainer = trainer.Trainer(model, dataset.CharCorruptionDataset(open(args.pretrain_corpus_path).read(), block_size), None, tconf)
    trainer.train()
    ...
    trainer = trainer.Trainer(model, dataset.NameDataset(pretrain_dataset, open(args.finetune_corpus_path).read()), None, tconf)
    trainer.train()
    torch.save(model.state_dict(), args.writing_params_path)
